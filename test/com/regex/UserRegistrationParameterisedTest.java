...
public class UserRegistrationParameterisedTest {
	...
	public static Collection input() {
		return Arrays.asList(new Object[][]{
				{"abc@yahoo.com", "Happy"}, {"abc-100@yahoo.com", "Happy"},	{"abc.100@yahoo.com", "Happy"},
				...
				{"abc@%*.com", "Sad"}, {"abc..2002@gmail.com", "Sad"}, {"abc.@gmail.com", "Sad"},
	...
	public void testUserRegistrationTest() {
		...
		Assert.assertEquals(expectedResult, userRegistration.validateEmail(testEmail));
	}
}
